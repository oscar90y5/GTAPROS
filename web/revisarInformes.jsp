                ...
                <div class="caja_small">
                    ...
                    <form role="form" action='RevisarInformes?idInforme=<%=informe.getId()%>' method="post">
                        <div class="box-footer text-right" style="margin-top: 10px">
                            <button type="submit" class="btn btn-primary" name="accion" value="Ahora">Aceptar</button>
                            <button type="submit" class="btn btn-danger" name="accion" value="Cancelar">Rechazar</button>
                        </div>
                    </form>
                </div>
                <% } %>  
