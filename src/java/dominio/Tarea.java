...
@NamedQueries({
    ...
    , @NamedQuery(name = "Tarea.findByIdActividadAndMiembro", query = "SELECT t FROM Tarea t WHERE t.tareaPK.idActividad = :idActividad AND t.tareaPK.idMiembro= :idMiembro")})
