...
public class ProyectosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Proyecto> allProyects = (ArrayList<Proyecto>) proyectoFacade.findAll();
        ArrayList<Proyecto> proyects = new ArrayList<>();
        if(estado==null){ }
        else{
            if(estado.equals("sinPlan")){
        ...
        String jsonProyects = mapper.writeValueAsString(proyects);
        request.setAttribute("proyectos", jsonProyects);
