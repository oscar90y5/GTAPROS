 ...
 * @author oscar
 */
@WebServlet(name = "RevisarInformes", urlPatterns = {"/RevisarInformes"})
public class RevisarInformes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(accion.equals("Aceptar")){
            Informetareas informe = informetareasFacade.find(Integer.valueOf(idInforme));
            informe.setEstado("Aceptado");
